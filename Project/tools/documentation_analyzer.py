...
def measure_documentation(code: str) -> Dict[str, Any]:
    ...
    try:
        ...
        missing: List[Dict[str, Any]] = [] if has_module_doc else [{"type": "module", "name": "<module>", "line": 1}]
        ...
        return {"documentation_percent": documentation_percent,
                "total_items": total_items, "documented_items": documented_items, "missing": missing[:10]}
    except Exception as error:
        return {"documentation_percent": 0.0, "total_items": 0,
